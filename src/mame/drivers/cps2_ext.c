...
ROM_START( ringdesta )		/* Ring of Destruction: Slammasters II (Asia 940831) */
	...
	ROM_LOAD16_WORD_SWAP( "smba.03a", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "smba.04a", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "smba.05a", 0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "smba.06a", 0x180000, 0x80000, VERIFY_OFF )
...
ROM_START( ringdesth )		/* Ring of Destruction: Slammasters II (Hispanic 940902) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "smbh.03b", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "smbh.04b", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "smbh.05b", 0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "smbh.06b", 0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "smbh.07b", 0x200000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "smbh.08b", 0x280000, 0x80000, VERIFY_OFF )
...
ROM_START( sfa3us )		/* Street Fighter Alpha 3 (USA 980616 Sample version) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sz3-usam_03.6a",  0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3-usam_04.7a",  0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3-usam_05.8a",  0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3-usam_06.9a",  0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3-usam_07.6d",  0x200000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3-usam_08.7d",  0x280000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3-usam_09.8d",  0x300000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3-usam_10.9d",  0x380000, 0x80000, VERIFY_OFF )
	...
	ROM_REGION( QSOUND_SIZE, "audiocpu", 0 )
	ROM_LOAD( "sz3-usam_01.1a",   0x00000, 0x08000, VERIFY_OFF )
	ROM_CONTINUE(         0x10000, 0x18000 )
	ROM_LOAD( "sz3-usam_02.2a",   0x28000, 0x20000, VERIFY_OFF )
...
ROM_START( sfz2jd )	/* Phoenix Edition, Street Fighter Alpha 2 (Japan 960227) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sz2j_d.03a", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz2j_d.04a", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz2.05a",    0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz2.06",     0x180000, 0x80000, CRC(5b1d49c0) SHA1(f0a0c894c9cbe2b18e7f59058665949ee0025732) )
	ROM_LOAD16_WORD_SWAP( "sz2j.07a",   0x200000, 0x80000, VERIFY_OFF )
...
ROM_START( sfz3jr2d )	/* Phoenix Edition, Street Fighter Alpha 3 (Japan 980629) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sz3j_d.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3j_d.04", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3.05",    0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3.06",    0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3.07",    0x200000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3.08",    0x280000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3.09",    0x300000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sz3.10",    0x380000, 0x80000, VERIFY_OFF )
...
ROM_START( progearjbl )
	...
	ROM_LOAD16_WORD_SWAP( "pgaj_bl.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "pgaj_bl.04",  0x080000, 0x80000, VERIFY_OFF )

	ROM_REGION( 0x1000000, "gfx", 0 )
	ROMX_LOAD( "pga.13m", 0x0000000, 0x400000, VERIFY_OFF, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "pga.15m", 0x0000002, 0x400000, VERIFY_OFF, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "pga.17m", 0x0000004, 0x400000, VERIFY_OFF, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "pga.19m", 0x0000006, 0x400000, VERIFY_OFF, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	ROM_REGION( 0x800000, "qsound", 0 )
	ROM_LOAD16_WORD_SWAP( "pga.11m", 0x000000, 0x400000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "pga.12m", 0x400000, 0x400000, VERIFY_OFF )
ROM_END

ROM_START( mvscjsing )		/* Marvel Vs. Capcom: Clash of Super Heroes (Japan 980123) (Single PCB) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_BYTE( "mvc_ja.simm1", 0x000000, 0x200000, VERIFY_OFF )
	ROM_LOAD16_BYTE( "mvc_ja.simm3", 0x000001, 0x200000, VERIFY_OFF )

	ROM_REGION( 0x2000000, "gfx", 0 )
	ROMX_LOAD( "mvc64-13m.13",   0x0000000, 0x800000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mvc64-15m.15",   0x0000002, 0x800000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mvc64-17m.17",   0x0000004, 0x800000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mvc64-19m.19",   0x0000006, 0x800000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	...
	ROM_REGION( 0x800000, "qsound", 0 )
	ROM_LOAD16_WORD_SWAP( "mvc64-11m.11",   0x000000, 0x800000, VERIFY_OFF )
ROM_END

ROM_START( ssf2th )		/* Super Street Fighter II Turbo (Hispanic 940223) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sfxh.03c", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxh.04a", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxh.05",  0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxh.06a", 0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxh.07",  0x200000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxh.08",  0x280000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxh.09",  0x300000, 0x80000, VERIFY_OFF )
...
ROM_START( ssf2tbh )		/* Super Street Fighter II: The Tournament Battle (Hispanic 931005) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "ssfh.03tb",  0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ssfh.04t",   0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ssfh.05t",   0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ssfh.06tb",  0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ssfh.07t",   0x200000, 0x80000, VERIFY_OFF )
...
ROM_START( ssf2tad )	/* Phoenix Edition, Super Street Fighter II Turbo (Asia 940223) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sfxad.03c", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxad.04a", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxad.05",  0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxad.06a", 0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxad.07",  0x200000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxad.08",  0x280000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxad.09",  0x300000, 0x80000, VERIFY_OFF )
...
ROM_START( cybotsud )		/* Phoenix Edition, Cyberbots: Fullmetal madness (USA 950424) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cybu_d.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "cybu_d.04", 0x080000, 0x80000, VERIFY_OFF )
...
ROM_START( ecofghtrd )		/* Phoenix Edition, Eco Fighters (World 931203) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "ueced.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ueced.04", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ueced.05", 0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ueced.06", 0x180000, 0x80000, VERIFY_OFF )
...
ROM_START( progearud )		/* Phoenix Edition, Progear (USA 010117) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "pgau_d.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "pgau_d.04", 0x080000, 0x80000, VERIFY_OFF )
...
ROM_START( gigawingd )		/* Phoenix Edition, Giga Wing (USA 990222) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "ggwu_d.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ggwu_d.04", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ggw_d.05",  0x100000, 0x80000, VERIFY_OFF )
...
ROM_START( mshvsfu1d )		/* Phoenix Edition, Marvel Super Heroes Vs. Street Fighter (USA 970625) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "mvsu_d.03d", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "mvsu_d.04d", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "mvs_d.05a",  0x100000, 0x80000, VERIFY_OFF )
...
ROM_START( vhunt2d )		/* Phoenix Edition, Vampire Hunter 2: Darkstalkers Revenge (Japan 970913) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "vh2j_d.03a", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "vh2j_d.04a", 0x080000, 0x80000, VERIFY_OFF )
...
ROM_START( vsav2d )		/* Phoenix Edition, Vampire Savior 2: The Lord of Vampire (Japan 970913) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "vs2j_d.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "vs2j_d.04", 0x080000, 0x80000, VERIFY_OFF )
...
ROM_START( csclub1d )		/* Phoenix Edition, Capcom Sports Club (Euro 970722) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "csce_d.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "csce_d.04", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "csce_d.05", 0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "csce_d.06", 0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "csc_d.07",  0x200000, 0x80000, VERIFY_OFF )
...
ROM_START( csclubjy )		/* Capcom Sports Club (Japan 970722, yellow case) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cscj.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "cscj.04", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "cscj.05", 0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "cscj.06", 0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "csc.07",  0x200000, 0x80000, VERIFY_OFF )
...
ROM_START( cybotsjd )		/* Cyberbots: Fullmetal Madness (Japan 950424 decrypted bootleg) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cybj_d.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "cybj_d.04", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "cyb.05",  0x100000, 0x80000, CRC(ec40408e) SHA1(dd611c1708e7ef86e4f7cac4b7b0dff7baaee5ed) )
	ROM_LOAD16_WORD_SWAP( "cyb.06",  0x180000, 0x80000, CRC(1ad0bed2) SHA1(2ea005f3e73b05f8f0ec006cd9e95f7731a73897) )
	ROM_LOAD16_WORD_SWAP( "cyb.07",  0x200000, 0x80000, CRC(6245a39a) SHA1(4f607e733e2dea80211497522be6d0f09571928d) )
	ROM_LOAD16_WORD_SWAP( "cyb.08",  0x280000, 0x80000, CRC(4b48e223) SHA1(9714579a7a78b9716e44bca6c18bf1a93aa4e482) )
...
ROM_START( spf2td )		/* Phoenix Edition, Super Puzzle Fighter II Turbo, (USA 960620) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "pzfu_d.03a", 0x000000, 0x80000, VERIFY_OFF )
...
ROM_START( ddsomar1 )		/* Dungeons & Dragons: Shadow over Mystara (Asia 960208) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "dd2a.03c", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "dd2a.04c", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "dd2a.05c", 0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "dd2a.06c", 0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "dd2.07",   0x200000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "dd2.08",   0x280000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "dd2.09",   0x300000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "dd2.10",   0x380000, 0x80000, VERIFY_OFF )
...
ROM_START( mmancp2ur1 )		/* Mega Man: The Power Battle (USA 950926, SAMPLE version) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "rcmu.03a", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "rcmu.04a", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "rcmu.05a", 0x100000, 0x80000, VERIFY_OFF )

	ROM_REGION( 0x1000000, "gfx", 0 )
	ROM_FILL(              0x000000, 0x800000, 0x00 )
	ROMX_LOAD( "rcm.73",   0x800000, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.63",   0x800002, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.83",   0x800004, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.93",   0x800006, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.74",   0xa00000, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.64",   0xa00002, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.84",   0xa00004, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.94",   0xa00006, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.75",   0xc00000, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.65",   0xc00002, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.85",   0xc00004, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.95",   0xc00006, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.76",   0xe00000, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.66",   0xe00002, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.86",   0xe00004, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "rcm.96",   0xe00006, 0x080000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )

	ROM_REGION(QSOUND_SIZE, "audiocpu", 0 )
	ROM_LOAD( "rcm.01",   0x00000, 0x08000, VERIFY_OFF )
	ROM_CONTINUE(         0x10000, 0x18000 )

	ROM_REGION( 0x400000, "qsound", 0 )
	ROM_LOAD16_WORD_SWAP( "rcm.51",   0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "rcm.52",   0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "rcm.53",   0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "rcm.54",   0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "rcm.55",   0x200000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "rcm.56",   0x280000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "rcm.57",   0x300000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "rcm.58",   0x380000, 0x80000, VERIFY_OFF )
ROM_END

ROM_START( vhuntjr1s )		/* Vampire Hunter: Darkstalkers's Revenge (950307 Japan, stop version) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "vphjstop.03b",	0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "vphj.04c",	0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "vphj.05d",	0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "vphj.06c",	0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "vphj.07b",	0x200000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "vphj.08b",	0x280000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "vphj.09b",	0x300000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "vphj.10b",	0x380000, 0x80000, VERIFY_OFF )
...
ROM_START( gigaman2 )		/* Giga Man - bootleg of Mega Man 2: The Power Fighters */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sys_rom1.bin", 0x000000, 0x400000, VERIFY_OFF )

	ROM_REGION( 0x10000, "mcu", 0x00 )
	ROM_LOAD( "89c4051.bin", 0x0000, 0x010000, NO_DUMP )

	ROM_REGION( 0x800000, "gfx", 0 )
	ROM_LOAD( "cg_rom1.bin", 0x0000000, 0x400000, VERIFY_OFF )

	ROM_IGNORE( 0x400000 )
	ROM_LOAD( "cg_rom2.bin", 0x0400000, 0x400000, VERIFY_OFF )
	ROM_IGNORE( 0x400000 )

	ROM_REGION( 0x800000, "oki", 0 )
	ROM_LOAD( "pcm_rom1.bin", 0x000000, 0x800000, VERIFY_OFF )
ROM_END
