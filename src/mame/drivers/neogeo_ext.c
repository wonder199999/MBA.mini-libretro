...
ROM_START( kof97pla )		/* The King of Fighters' 97 Oroshi Plus 2003 (bootleg set 1) */
	ROM_REGION( 0x500000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "kf97-p1a.bin", 0x000000, 0x100000, NO_DUMP )
	ROM_LOAD16_WORD_SWAP( "232-p2.bin",  0x100000, 0x400000, NO_DUMP )

	NEO_SFIX_128K( "kf97-s1a.bin", NO_DUMP )
	NEO_BIOS_AUDIO_128K( "232-m1.bin", NO_DUMP )
	...
	ROM_REGION( 0x2800000, "sprites", 0 )
	ROM_LOAD16_BYTE( "232-c1.bin", 0x0000000, 0x800000, NO_DUMP )
	ROM_LOAD16_BYTE( "232-c2.bin", 0x0000001, 0x800000, NO_DUMP )
	ROM_LOAD16_BYTE( "232-c3.bin", 0x1000000, 0x800000, NO_DUMP )
	ROM_LOAD16_BYTE( "232-c4.bin", 0x1000001, 0x800000, NO_DUMP )
	ROM_LOAD16_BYTE( "232-c5.bin", 0x2000000, 0x400000, NO_DUMP )
	ROM_LOAD16_BYTE( "232-c6.bin", 0x2000001, 0x400000, NO_DUMP )
...
ROM_START( kof97xt )		/* The King of Fighters' 97 - Final Battle (hack) */
	ROM_REGION( 0x500000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "232xt-p1.bin", 0x000000, 0x100000, NO_DUMP )
	ROM_LOAD16_WORD_SWAP( "232xt-p2.bin", 0x100000, 0x400000, NO_DUMP )

	NEO_SFIX_128K( "232xt-s1.bin", NO_DUMP )
	NEO_BIOS_AUDIO_128K( "232-m1.bin", NO_DUMP )
	...
	ROM_REGION( 0x3000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "232xt-c1.bin", 0x0000000, 0x800000, NO_DUMP )
	ROM_LOAD16_BYTE( "232xt-c2.bin", 0x0000001, 0x800000, NO_DUMP )
	ROM_LOAD16_BYTE( "232-c3.bin",   0x1000000, 0x800000, NO_DUMP )
	ROM_LOAD16_BYTE( "232-c4.bin",   0x1000001, 0x800000, NO_DUMP )
	ROM_LOAD16_BYTE( "232xt-c5.bin", 0x2000000, 0x800000, NO_DUMP )
	ROM_LOAD16_BYTE( "232xt-c6.bin", 0x2000001, 0x800000, NO_DUMP )
ROM_END
