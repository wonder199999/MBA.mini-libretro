...
GAME( 1998, sfa3h,      sfa3,     cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "Street Fighter Alpha 3 (Hispanic 980904)", GAME_SUPPORTS_SAVE )
...
GAME( 1998, sfa3hr1,    sfa3,     cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "Street Fighter Alpha 3 (Hispanic 980629)", GAME_SUPPORTS_SAVE )
...
ROM_START( sfaud )	/* Street Fighter Alpha - warrior's dreams (1995.07.27 USA, Phoenix Edition) */
	...
	ROM_LOAD16_WORD_SWAP( "sfzud.03a", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfz.04b",   0x080000, 0x80000, CRC(8b73b0e5) SHA1(5318761f615c21395366b5333e75eaaa73ef2073) )
	ROM_LOAD16_WORD_SWAP( "sfz.05a",   0x100000, 0x80000, CRC(0810544d) SHA1(5f39bda3e7b16508eb58e5a2e0cc58c09cf428ce) )
	ROM_LOAD16_WORD_SWAP( "sfz.06",    0x180000, 0x80000, CRC(806e8f38) SHA1(b6d6912aa8f2f590335d7ff9a8214648e7131ebb) )
...
ROM_START( ssf2td )	/* Super Street Fighter II Turbo (1994.02.23 ETC, Phoenix Edition)  */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sfxed.03c", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxed.04a", 0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxed.05",  0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxed.06a", 0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxed.07",  0x200000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxed.08",  0x280000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "sfxed.09",  0x300000, 0x80000, VERIFY_OFF )
...
ROM_START( ssf2d )	/* Super Street Fighters II - the new challengers (1993.09.11 ETC, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "ssfed.03",  0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ssfed.04",  0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ssfed.05",  0x100000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ssfed.06",  0x180000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "ssfed.07",  0x200000, 0x80000, VERIFY_OFF )
	...
	ROM_REGION( QSOUND_SIZE, "audiocpu", 0 )
	ROM_LOAD( "ssf.01",   0x00000, 0x08000, VERIFY_OFF )
	ROM_CONTINUE(         0x10000, 0x18000 )
...
ROM_START( mpangjd )	/* Mighty! Pang (2000.10.11 Japan, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "mpnj-pnx.03", 0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "mpnj-pnx.04", 0x080000, 0x80000, VERIFY_OFF )
...
ROM_START( 1944ad )	/* Phoenix Edition, 1944 - the loop master (USA 000620, alt) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "nffuad.03", 0x000000, 0x80000,  VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "nff.04",  0x080000, 0x80000, CRC(dba1c66e) SHA1(4764e77d4da5d19d9acded27df1e1bcba06b0fcf) )
	ROM_LOAD16_WORD_SWAP( "nffu.05", 0x100000, 0x80000, CRC(ea813eb7) SHA1(34e0175a5f22d08c3538369b4bfd077a7427a128) )
...
ROM_START( hsf2da )	/* Hyper Street Fighters II: The Anniversary Edition (2004.02.02 Asia, Phoenix Edition, alt) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "hs2ad.03",  0x000000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "hs2ad.04",  0x080000, 0x80000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "hs2.05",    0x100000, 0x80000, CRC(dde34a35) SHA1(f5be2d2916db6e86e0886d61d55bddf138273ebc) )
	ROM_LOAD16_WORD_SWAP( "hs2.06",    0x180000, 0x80000, CRC(f4e56dda) SHA1(c6490707c2a416ab88612c2d73abbe5853d8cb92) )
	ROM_LOAD16_WORD_SWAP( "hs2.07",    0x200000, 0x80000, CRC(ee4420fc) SHA1(06cf76660b0c794d2460c52d9fe8334fff51e9de) )
	ROM_LOAD16_WORD_SWAP( "hs2.08",    0x280000, 0x80000, CRC(c9441533) SHA1(bf178fac1f060fcce3ff9118333c8517dadc9429) )
	...
	ROM_REGION( 0x2000000, "gfx", 0 )
	ROMX_LOAD( "hs2.13",   0x0000000, 0x400000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.15",   0x0000002, 0x400000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.17",   0x0000004, 0x400000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.19",   0x0000006, 0x400000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.14",   0x1000000, 0x400000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.16",   0x1000002, 0x400000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.18",   0x1000004, 0x400000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.20",   0x1000006, 0x400000, VERIFY_OFF , ROM_GROUPWORD | ROM_SKIP(6) )
	...
	ROM_REGION( 0x800000, "qsound", 0 )
	ROM_LOAD16_WORD_SWAP( "hs2(__hsf2da).11m", 0x000000, 0x400000, VERIFY_OFF )
	ROM_LOAD16_WORD_SWAP( "hs2.12m",	   0x400000, 0x400000, VERIFY_OFF )
ROM_END
