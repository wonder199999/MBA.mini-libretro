...
ROM_START( majtitl2a )		/* Major Title 2 (World, set 1, alt sound CPU) */
	...
	ROM_LOAD16_BYTE( "mt2-h0-.5m", 0x000001, 0x40000, VERIFY_OFF )
	ROM_LOAD16_BYTE( "mt2-l0-.5f", 0x000000, 0x40000, VERIFY_OFF )
	ROM_LOAD16_BYTE( "mt2-h1-.5l", 0x100001, 0x40000, VERIFY_OFF )
	ROM_LOAD16_BYTE( "mt2-l1-.5j", 0x100000, 0x40000, VERIFY_OFF )

	ROM_REGION( 0x100000, "soundcpu", 0 )
	ROM_LOAD16_BYTE( "mt2sh0-a",  0x000001, 0x10000, VERIFY_OFF )
	ROM_LOAD16_BYTE( "mt2sl0-a",  0x000000, 0x10000, VERIFY_OFF )
