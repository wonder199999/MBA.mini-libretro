...
GAME( 1992,	sf2amf2,	sf2ce,		cps1_12MHz,	sf2hack,	sf2hack,	ROT0,"	bootleg",	"Street Fighter II': Champion Edition (L735 Test Rom, bootleg)", GAME_SUPPORTS_SAVE )	// 920313 - based on World version
