...
void m68ki_build_opcode_table(void)
{
	...
	while (ostruct->mask != 0xff00)
	{
		for (i = 0; i < 0x10000; i++)
		{
			if ((i & ostruct->mask) == ostruct->match)
			{
				...
				m68ki_cycles[i] = ostruct->cycles[0];
			}
		}
		ostruct++;
	}
	...
	while (ostruct->mask == 0xff00)
	{
		for (i = 0; i <= 0xff; i++)
		{
			...
			m68ki_cycles[ostruct->match | i] = ostruct->cycles[0];
		}
		ostruct++;
	}
	...
	while (ostruct->mask == 0xf1f8)
	{
		for (i = 0; i < 8; i++)
		{
			for (j = 0; j < 8; j++)
			{
				...
				m68ki_cycles[instr] = ostruct->cycles[0];
			}
		}
		ostruct++;
	}
	...
	while (ostruct->mask == 0xf1ff)
	{
		for (i = 0; i <= 0x07; i++)
		{
			...
			m68ki_cycles[ostruct->match | (i << 9)] = ostruct->cycles[0];
		}
		ostruct++;
	}
	...
	while (ostruct->mask == 0xffff)
	{
		...
		m68ki_cycles[ostruct->match] = ostruct->cycles[0];
