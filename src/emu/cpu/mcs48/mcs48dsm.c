...
static UINT32 common_dasm(running_device *device, char *buffer, offs_t pc, const UINT8 *oprom, const UINT8 *opram, int upi41)
{
	...
	switch (*oprom++)
	{
		...
		case 0xe8:		sprintf(buffer, "djnz r0,$%03X", (pc & 0xf00) | *opram++);
					flags = DASMFLAG_STEP_OVER;
				break;
		case 0xe9:		sprintf(buffer, "djnz r1,$%03X", (pc & 0xf00) | *opram++);
					flags = DASMFLAG_STEP_OVER;
				break;
		case 0xea:		sprintf(buffer, "djnz r2,$%03X", (pc & 0xf00) | *opram++);
					flags = DASMFLAG_STEP_OVER;
				break;
		case 0xeb:		sprintf(buffer, "djnz r3,$%03X", (pc & 0xf00) | *opram++);
					flags = DASMFLAG_STEP_OVER;
				break;
		case 0xec:		sprintf(buffer, "djnz r4,$%03X", (pc & 0xf00) | *opram++);
					flags = DASMFLAG_STEP_OVER;
				break;
		case 0xed:		sprintf(buffer, "djnz r5,$%03X", (pc & 0xf00) | *opram++);
					flags = DASMFLAG_STEP_OVER;
				break;
		case 0xee:		sprintf(buffer, "djnz r6,$%03X", (pc & 0xf00) | *opram++);
					flags = DASMFLAG_STEP_OVER;
				break;
		case 0xef:		sprintf(buffer, "djnz r7,$%03X", (pc & 0xf00) | *opram++);
					flags = DASMFLAG_STEP_OVER;
				break;
