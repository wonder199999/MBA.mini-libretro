...
static UINT32 common_dasm(running_device *device, char *buffer, offs_t pc, const UINT8 *oprom, const UINT8 *opram)
{
	...
	switch (*oprom++)
	{
		...
		case 0x02:		sprintf(buffer, "out  bus,a");						break;
		...
		case 0x08:		sprintf(buffer, "in   a,bus");						break;
		...
		case 0x22:		sprintf(buffer, "illegal");						break;
		...
		case 0x75:		sprintf(buffer, "ent0 clk");						break;
		...
		case 0x80:		sprintf(buffer, "movx a,@r0");						break;
		case 0x81:		sprintf(buffer, "movx a,@r1");						break;
		...
		case 0x86:		sprintf(buffer, "jni  $%03X", (pc & 0xf00) | *opram++);			break;
		case 0x88:		sprintf(buffer, "orl  bus,#$%02X", *opram++);				break;
		...
		case 0x90:		sprintf(buffer, "movx @r0,a");						break;
		case 0x91:		sprintf(buffer, "movx @r1,a");						break;
		...
		case 0x98:		sprintf(buffer, "anl  bus,#$%02X", *opram++);				break;
		...
		case 0xd6:		sprintf(buffer, "illegal");						break;
		...
		case 0xe5:		sprintf(buffer, "sel  mb0");						break;
		...
		case 0xe8:		sprintf(buffer, "djnz r0,$%03X", (pc & 0xf00) | *opram++);
					flags = DASMFLAG_STEP_OVER;						break;
		...
		case 0xf5:		sprintf(buffer, "sel  mb1");						break;
...
{
	return common_dasm(device, buffer, pc, oprom, opram);
}
