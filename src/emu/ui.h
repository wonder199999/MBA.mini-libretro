...
#define UI_BACKGROUND_COLOR		MAKE_ARGB(0xFF, 0x00, 0x00, 0x00)
...
#define UI_SELECTED_COLOR		MAKE_ARGB(0xff, 0xff, 0xa5, 0x00)
#define UI_SELECTED_BG_COLOR		MAKE_ARGB(0xe0, 0x70, 0x80, 0x90)
