...
JOYPAD controls are: 
	...
	RETRO_DEVICE_ID_JOYPAD_A		Button 1
	RETRO_DEVICE_ID_JOYPAD_B		Button 2
	RETRO_DEVICE_ID_JOYPAD_X		Button 3
	RETRO_DEVICE_ID_JOYPAD_Y		Button 4
	RETRO_DEVICE_ID_JOYPAD_L		Button 5
	RETRO_DEVICE_ID_JOYPAD_R		Button 6
